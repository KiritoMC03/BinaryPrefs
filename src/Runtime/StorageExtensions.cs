...
namespace Appegy.Storage
{
    public static class StorageExtensions
    {
        ...
        public static IStoredProperty<T> GetProperty<T>(
            [NotNull] this IBinaryStorage storage,
            [NotNull] string key,
            [CanBeNull] T defaultValue = default,
            [CanBeNull] MissingKeyBehavior? missingKeyBehavior = null,
            [CanBeNull] TypeMismatchBehaviour? typeMismatchBehaviour = null)
        {
            if (storage == null)
