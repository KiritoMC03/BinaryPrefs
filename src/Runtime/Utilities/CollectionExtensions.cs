...
namespace Appegy.Storage
{
    internal static class CollectionExtensions
    {
        ...
        public static void AddRange<TKey, TValue>
            (this IDictionary<TKey, TValue> source, (TKey Key, TValue Value) item1, (TKey Key, TValue Value) item2)
        {
        ...
        (
            ...
            (TKey Key, TValue Value) item1,
            (TKey Key, TValue Value) item2,
            (TKey Key, TValue Value) item3
        )
        {
            source.Add(item1.Key, item1.Value);
            source.Add(item2.Key, item2.Value);
        ...
        public static void AddRange<TKey, TValue>
            (this IDictionary<TKey, TValue> source, params (TKey Key, TValue Value)[] items)
        {
